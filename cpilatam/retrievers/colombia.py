...
from cpilatam import logger
from cpilatam.names import CPIColumns
from cpilatam.retrievers.base import SeleniumDownloaderMixin
...
class ColombiaCPIRetriever(SeleniumDownloaderMixin):
    ...
    def __init__(self):
        ...
        self.local_file_path = "cpilatam/retrievers/retrieved_files"
        self.attempts = 10
    ...
    def launch(self):
        ...
        self.save(self.parse(f"{path}/colombia_cpi.xlsx"), f"{path}/colombia_cpi.csv")

    def download(self):
        download_dir = Path(__file__).parent / "retrieved_files"
...
if __name__ == "__main__":
    ...
    # retriever.launch()
    path = "cpilatam/retrievers/retrieved_files"
    retriever.save(retriever.parse(f"{path}/colombia_cpi.xlsx"), f"{path}/colombia_cpi.csv")
